...
CREATE DATABASE `db_turismo` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `db_turismo`;
...
CREATE TABLE `tb_carrinho` (
  `idtb_carrinho` int(11) NOT NULL,
  `tb_lugar_idtb_lugar` int(11) NOT NULL,
  PRIMARY KEY (`idtb_carrinho`,`tb_lugar_idtb_lugar`),
  KEY `fk_tb_carrinho_tb_lugar1_idx` (`tb_lugar_idtb_lugar`),
  CONSTRAINT `fk_tb_carrinho_tb_lugar1` FOREIGN KEY (`tb_lugar_idtb_lugar`) REFERENCES `tb_lugar` (`idtb_lugar`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `tb_cliente` (
  ...
  `tb_carrinho_idtb_carrinho` int(11) NOT NULL,
  PRIMARY KEY (`idtb_cliente`),
  UNIQUE KEY `senha_cliente_UNIQUE` (`senha_cliente`),
  KEY `fk_tb_cliente_tb_carrinho1_idx` (`tb_carrinho_idtb_carrinho`),
  CONSTRAINT `fk_tb_cliente_tb_carrinho1` FOREIGN KEY (`tb_carrinho_idtb_carrinho`) REFERENCES `tb_carrinho` (`idtb_carrinho`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
